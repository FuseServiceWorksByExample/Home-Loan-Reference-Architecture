...
/**
 * A loan application validator.
 */
public final class ApplicationValidator {

    /**
     * @param application the application being validated (can be <code>null</code>)
     * @return <code>true</code> if not <code>null</code> and all fields are valid
     */
    public static boolean isValid( final Application application ) {
